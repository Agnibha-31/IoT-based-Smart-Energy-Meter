...
The `PCB Fabrication/` folder contains the existing `Smart Meter IoT` hardware fabrication job for this renamed repository. The job was generated by KiCad Pcbnew 10.0.2.
...
```bash
git clone https://github.com/Agnibha-31/IoT-based-Smart-Energy-Meter.git
cd IoT-based-Smart-Energy-Meter
```
...
> “Smart Meter Domestic Dataset,” Agnibha Basak, IoT based Smart Energy Meter, 2026, licensed under CC BY 4.0. https://github.com/Agnibha-31/IoT-based-Smart-Energy-Meter
...
```bibtex
@software{basak_iot_based_smart_energy_meter_2026,
  author  = {Agnibha Basak},
  title   = {IoT based Smart Energy Meter},
  year    = {2026},
  url     = {https://github.com/Agnibha-31/IoT-based-Smart-Energy-Meter}
}
```
...
For custom IoT dashboards, smart-energy platforms, ESP32 integration, data analytics, deployment, or business collaboration, mail at: [remix.play31@gmail.com](https://mail.google.com/mail/?view=cm&fs=1&to=remix.play31@gmail.com&su=IoT%20based%20Smart%20Energy%20Meter%20Enquiry)
