...
<p align="center">
  <img src="Circuit%20Image.png" alt="Complete IoT based Smart Energy Meter connection illustration with ESP32, LCD, ACS712, ZMPT101B, supply, and load" width="900">
</p>
...
<p align="center">
  <img src="Circuit%20Scematic.png" alt="IoT based Smart Energy Meter schematic showing ACS712, ZMPT101B, and ESP32 connections" width="900">
</p>
...
<p align="center">
  <img src="PCB.png" alt="IoT based Smart Energy Meter PCB render with ACS712, ZMPT101B, ESP32, and antenna area" width="900">
</p>
...
The `PCB Fabrication/` folder now contains a consistent IoT based Smart Energy Meter job generated by KiCad Pcbnew 10.0.2.

| Verified property | Value |
|---|---:|
| Project identifier | `IoT based Smart Energy Meter` |
...
|---|---|
| [`IoT based Smart Energy Meter-F_Cu.gbr`](PCB%20Fabrication/Smart%20Meter%20IoT-F_Cu.gbr) | Top copper |
| [`IoT based Smart Energy Meter-B_Cu.gbr`](PCB%20Fabrication/Smart%20Meter%20IoT-B_Cu.gbr) | Bottom copper |
| [`IoT based Smart Energy Meter-F_Mask.gbr`](PCB%20Fabrication/Smart%20Meter%20IoT-F_Mask.gbr) | Top solder mask |
| [`IoT based Smart Energy Meter-B_Mask.gbr`](PCB%20Fabrication/Smart%20Meter%20IoT-B_Mask.gbr) | Bottom solder mask |
| [`IoT based Smart Energy Meter-F_Silkscreen.gbr`](PCB%20Fabrication/Smart%20Meter%20IoT-F_Silkscreen.gbr) | Top legend/silkscreen |
| [`IoT based Smart Energy Meter-Edge_Cuts.gbr`](PCB%20Fabrication/Smart%20Meter%20IoT-Edge_Cuts.gbr) | Board profile |
| [`IoT based Smart Energy Meter-PTH.drl`](PCB%20Fabrication/Smart%20Meter%20IoT-PTH.drl) | Plated drill file |
| [`IoT based Smart Energy Meter-NPTH.drl`](PCB%20Fabrication/Smart%20Meter%20IoT-NPTH.drl) | Non-plated drill file; currently contains no holes |
| [`IoT based Smart Energy Meter-job.gbrjob`](PCB%20Fabrication/Smart%20Meter%20IoT-job.gbrjob) | Gerber job metadata |
| [`IoT based Smart Energy Meter.kicad_prl`](PCB%20Fabrication/Smart%20Meter%20IoT.kicad_prl) | KiCad local project settings; not the PCB design source |
...
<p align="center">
  <img src="Dashboard%20View/SignUp%20Page.png" alt="IoT based Smart Energy Meter sign-up and sign-in page" width="900">
</p>

### 2. Data overview

<p align="center">
  <img src="Dashboard%20View/Data%20Overview%20Page.png" alt="IoT based Smart Energy Meter overview page" width="900">
</p>
...
<p align="center">
  <img src="Dashboard%20View/Settings%20Page.png" alt="IoT based Smart Energy Meter settings page" width="900">
</p>
...
├── PCB.png
├── PCB Fabrication/
│   ├── IoT based Smart Energy Meter-F_Cu.gbr
│   ├── IoT based Smart Energy Meter-B_Cu.gbr
│   ├── IoT based Smart Energy Meter-F_Mask.gbr
│   ├── IoT based Smart Energy Meter-B_Mask.gbr
│   ├── IoT based Smart Energy Meter-F_Silkscreen.gbr
│   ├── IoT based Smart Energy Meter-Edge_Cuts.gbr
│   ├── IoT based Smart Energy Meter-PTH.drl
│   ├── IoT based Smart Energy Meter-NPTH.drl
│   ├── IoT based Smart Energy Meter-job.gbrjob
│   └── IoT based Smart Energy Meter.kicad_prl
├── System Code.ino
...
> “Smart Meter Domestic Dataset,” Agnibha Basak, IoT based Smart Energy Meter, 2026, licensed under CC BY 4.0. https://github.com/Agnibha-31/Smart-Meter-IoT
